package org.neodev.bananafrita;
...
@Mod(BananaFrita.MODID)
public class BananaFrita {
    // Define mod id in a common place for everything to reference
    public static final String MODID = "bananafrita";
    ...
    public BananaFrita(IEventBus modEventBus, ModContainer modContainer) {
